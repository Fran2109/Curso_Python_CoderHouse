...
class FormularioMensajeNuevo(forms.ModelForm):
    ...
    # El modelo que se utilizará para generar el formulario, así como los campos que se mostrarán en el formulario.
    # Además, se define un diccionario de ayuda vacío que se utiliza para eliminar cualquier texto de ayuda predeterminado generado por Django.
    class Meta:
        model = Mensaje
        fields = ['contenido']
